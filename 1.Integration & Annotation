 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# scRNAseq comprehensive analysis – Integration & Annotation"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "id": "8d5c3cca-c442-4ed7-9755-b2e88203fc13",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  {
   "cell_type": "markdown",
   "id": "7813a8d7-9132-4c90-8393-d4fc7b62b575",
   "metadata": {},
   "source": [
    "## Set Environment "
   ]
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "8a4ad675-306c-49df-8a06-bc96d32b5387",
   "metadata": {},
   "outputs": [],
   "source": [
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       ...
       "    uns: 'harmony_leiden_Biopsy_site_T0_1', 'harmony_leiden_orig.ident_1', 'harmony_nn_Biopsy_site_T0', 'harmony_nn_orig.ident', 'harmony_umap_Biopsy_site_T0', 'harmony_umap_orig.ident', 'hvg', 'leiden_1', 'log1p', 'neighbors', 'over_clustering', 'pca', 'umap'\n",
       "    obsm: 'X_harmony_Biopsy_site_T0', 'X_harmony_orig.ident', 'X_harmony_umap_Biopsy_site_T0', 'X_harmony_umap_orig.ident', 'X_pca', 'X_umap'\n",
       "    varm: 'PCs'\n",
       "    layers: 'log1p', 'raw_counts'\n",
       "    obsp: 'connectivities', 'distances', 'harmony_nn_Biopsy_site_T0_connectivities', 'harmony_nn_Biopsy_site_T0_distances', 'harmony_nn_orig.ident_connectivities', 'harmony_nn_orig.ident_distances'"
      ]
     },
     "execution_count": 38,
     "metadata": {},
   ...
   "outputs": [
    ...
    },
    {
     ...
     "text": [
      ...
      "2025-11-03 14:30:38 | [INFO] Converged after 5 iterations\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     "data": {
      "application/vnd.microsoft.datawrangler.viewer.v0+json": {
       ...
       "ref": "b72f04b4-a76c-462f-9d30-745a6178ed1b",
       "rows": [
        [
         "MBC",
         "50820"
